...
var len__5726__auto___22010 = arguments.length;
var i__5727__auto___22011 = (0);
while(true){
if((i__5727__auto___22011 < len__5726__auto___22010)){
...
/** @this {Function} */
(shitsuke.tokens.deep_merge.cljs$lang$applyTo = (function (seq21870){
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$pair__GT_css_$_iter__21898(s__21899){
return (new cljs.core.LazySeq(null,(function (){
var s__21899__$1 = s__21899;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__21899__$1);
if(temp__5825__auto__){
var s__21899__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21899__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21899__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21901 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21900 = (0);
while(true){
if((i__21900 < size__5479__auto__)){
var vec__21902 = cljs.core._nth(c__5478__auto__,i__21900);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21902,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21902,(1),null);
cljs.core.chunk_append(b__21901,["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22024 = (i__21900 + (1));
i__21900 = G__22024;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21901),shitsuke$tokens$pair__GT_css_$_iter__21898(cljs.core.chunk_rest(s__21899__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21901),null);
}
} else {
var vec__21905 = cljs.core.first(s__21899__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21905,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21905,(1),null);
return cljs.core.cons(["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$tokens$pair__GT_css_$_iter__21898(cljs.core.rest(s__21899__$2)));
}
} else {
return null;
}
...
var body = clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$iter__21916(s__21917){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__21923 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21923,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21923,(1),null);
var iterys__5476__auto__ = ((function (s__21917__$1,vec__21923,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function shitsuke$tokens$iter__21916_$_iter__21918(s__21919){
return (new cljs.core.LazySeq(null,((function (s__21917__$1,vec__21923,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
var s__21919__$1 = s__21919;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__21919__$1);
if(temp__5825__auto____$1){
var s__21919__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__21919__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21919__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21921 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21920 = (0);
while(true){
if((i__21920 < size__5479__auto__)){
var vec__21927 = cljs.core._nth(c__5478__auto__,i__21920);
...
if((!((v == null)))){
cljs.core.chunk_append(b__21921,shitsuke.tokens.pair__GT_css(group,k,v));

var G__22064 = (i__21920 + (1));
i__21920 = G__22064;
continue;
} else {
var G__22065 = (i__21920 + (1));
i__21920 = G__22065;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21921),shitsuke$tokens$iter__21916_$_iter__21918(cljs.core.chunk_rest(s__21919__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21921),null);
}
} else {
var vec__21930 = cljs.core.first(s__21919__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.tokens.pair__GT_css(group,k,v),shitsuke$tokens$iter__21916_$_iter__21918(cljs.core.rest(s__21919__$2)));
} else {
var G__22067 = cljs.core.rest(s__21919__$2);
s__21919__$1 = G__22067;
continue;
}
}
} else {
...
});})(s__21917__$1,vec__21923,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__21917__$1,vec__21923,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,shitsuke$tokens$iter__21916(cljs.core.rest(s__21917__$1)));
} else {
var G__22072 = cljs.core.rest(s__21917__$1);
s__21917__$1 = G__22072;
continue;
}
} else {
return null;
...
var map__21937 = deck_design;
var map__21937__$1 = cljs.core.__destructure_map(map__21937);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21937__$1,new cljs.core.Keyword("slides","theme","slides/theme",-79736158));
var text_styles = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21937__$1,new cljs.core.Keyword("slides","text-styles","slides/text-styles",-2082623934));
...
var color_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21939){
...
var type_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21943){
var vec__21945 = p__21943;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21945,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21945,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,(function (){var G__21948 = cljs.core.PersistentArrayMap.EMPTY;
var G__21948__$1 = (cljs.core.truth_(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21948,new cljs.core.Keyword(null,"font-size","font-size",-1847940346),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts)),"px"].join('')):G__21948);
var G__21948__$2 = (cljs.core.truth_(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21948__$1,new cljs.core.Keyword(null,"color","color",1011675173),shitsuke.tokens.normalize_hex(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))):G__21948__$1);
if(cljs.core.truth_(new cljs.core.Keyword("slides","bold","slides/bold",-1297473049).cljs$core$IFn$_invoke$arity$1(ts))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21948__$2,new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(700));
} else {
return G__21948__$2;
}
})()], null);
})),text_styles);
var font_family = (function (){var or__5002__auto__ = (function (){var G__21949 = new cljs.core.Keyword("office-style.font","majorFont","office-style.font/majorFont",1886256746).cljs$core$IFn$_invoke$arity$1(fonts);
if((G__21949 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21949),", system-ui, sans-serif"].join('');
}
})();
...
var G__21951 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("shitsuke","colors","shitsuke/colors",-494612392),color_tokens], null);
if(cljs.core.seq(type_tokens)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21951,new cljs.core.Keyword("shitsuke","type","shitsuke/type",1602529816),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21952){
var vec__21953 = p__21952;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21953,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21953,(1),null);
