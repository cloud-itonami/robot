...
return byoubu.color.mix((function (){var iter__5480__auto__ = (function byoubu$facts$declared_content_color_$_iter__22615(s__22616){
...
var c__5478__auto__ = cljs.core.chunk_first(s__22616__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22618 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22617 = (0);
while(true){
if((i__22617 < size__5479__auto__)){
var vec__22619 = cljs.core._nth(c__5478__auto__,i__22617);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22619,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22619,(1),null);
cljs.core.chunk_append(b__22618,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null));

var G__22656 = (i__22617 + (1));
i__22617 = G__22656;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22618),byoubu$facts$declared_content_color_$_iter__22615(cljs.core.chunk_rest(s__22616__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22618),null);
}
} else {
var vec__22622 = cljs.core.first(s__22616__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22622,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22622,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null),byoubu$facts$declared_content_color_$_iter__22615(cljs.core.rest(s__22616__$2)));
}
} else {
return null;
}
...
var G__22625 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"declared","declared",92336021),byoubu.facts.declared_content_color(backdrop)], null);
var G__22625__$1 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22625,new cljs.core.Keyword(null,"plate","plate",-1920178141),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null))):G__22625);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22625__$1,new cljs.core.Keyword(null,"poster","poster",-1616913550),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"poster","poster",-1616913550),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)));
} else {
return G__22625__$1;
}
});
...
return cljs.core.first(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p__22627){
var vec__22628 = p__22627;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22628,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22628,(1),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22628,(2),null);
return (- r);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__22631){
var vec__22632 = p__22631;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22632,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22632,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,hex,cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22626_SHARP_){
var or__5002__auto__ = byoubu.color.contrast_ratio(hex,p1__22626_SHARP_);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return 0.0;
...
var vec__22635 = byoubu.facts.best_ink(cljs.core.vals(tiers));
var ink_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22635,(0),null);
var ink = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22635,(1),null);
var ratio = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22635,(2),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22641),byoubu$facts$derive_facts_$_iter__22638(cljs.core.chunk_rest(s__22639__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22641),null);
}
} else {
var vec__22649 = cljs.core.first(s__22639__$2);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t,byoubu.color.contrast_ratio(ink,c)], null),byoubu$facts$derive_facts_$_iter__22638(cljs.core.rest(s__22639__$2)));
}
} else {
return null;
}
