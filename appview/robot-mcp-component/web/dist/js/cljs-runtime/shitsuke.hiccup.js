...
var vec__22001 = node;
var seq__22002 = cljs.core.seq(vec__22001);
var first__22003 = cljs.core.first(seq__22002);
var seq__22002__$1 = cljs.core.next(seq__22002);
var t = first__22003;
var body = seq__22002__$1;
var vec__22004 = (shitsuke.hiccup.parse_tag.cljs$core$IFn$_invoke$arity$1 ? shitsuke.hiccup.parse_tag.cljs$core$IFn$_invoke$arity$1(t) : shitsuke.hiccup.parse_tag.call(null, t));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22004,(0),null);
var base = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22004,(1),null);
var vec__22007 = ((cljs.core.map_QMARK_(cljs.core.first(body)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(body),cljs.core.rest(body)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentArrayMap.EMPTY,body], null));
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22007,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22007,(1),null);
...
var attrs__$2 = (function (){var G__22013 = attrs__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,"textarea")){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__22013,new cljs.core.Keyword(null,"value","value",305978217));
} else {
return G__22013;
}
})();
...
var content_22042 = shitsuke.hiccup.raw_text_content(children);
shitsuke.hiccup.assert_no_rawtext_breakout_BANG_(tag,content_22042);

cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(sb,content_22042);
} else {
