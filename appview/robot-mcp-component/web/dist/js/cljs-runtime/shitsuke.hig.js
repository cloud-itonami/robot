...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23047){
 ...
 */
shitsuke.hig.default_hig_tokens = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword("hig","font","hig/font",-1506004751),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"text","text",-1790561697),shitsuke.hig.font_family_text,new cljs.core.Keyword(null,"display","display",242065432),shitsuke.hig.font_family_display,new cljs.core.Keyword(null,"mono","mono",-1777958350),shitsuke.hig.font_family_mono], null),new cljs.core.Keyword("hig","text","hig/text",-1790736923),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23051){
var vec__23052 = p__23051;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23052,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23052,(1),null);
...
})),shitsuke.hig.text_styles),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__23055){
var vec__23056 = p__23055;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23056,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23056,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$pair__GT_css_$_iter__23066(s__23067){
return (new cljs.core.LazySeq(null,(function (){
var s__23067__$1 = s__23067;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23067__$1);
if(temp__5825__auto__){
var s__23067__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23067__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23067__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23069 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23068 = (0);
while(true){
if((i__23068 < size__5479__auto__)){
var vec__23070 = cljs.core._nth(c__5478__auto__,i__23068);
...
cljs.core.chunk_append(b__23069,["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__23336 = (i__23068 + (1));
i__23068 = G__23336;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23069),shitsuke$hig$pair__GT_css_$_iter__23066(cljs.core.chunk_rest(s__23067__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23069),null);
}
} else {
var vec__23074 = cljs.core.first(s__23067__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23074,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23074,(1),null);
return cljs.core.cons(["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$hig$pair__GT_css_$_iter__23066(cljs.core.rest(s__23067__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$tokens__GT_css_lines_$_iter__23111(s__23112){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__23116 = cljs.core._nth(c__5478__auto__,i__23113);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23116,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23116,(1),null);
if((!((m == null)))){
cljs.core.chunk_append(b__23114,((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (i__23113,s__23112__$1,vec__23116,group,m,c__5478__auto__,size__5479__auto__,b__23114,s__23112__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__23111_$_iter__23119(s__23120){
return (new cljs.core.LazySeq(null,((function (i__23113,s__23112__$1,vec__23116,group,m,c__5478__auto__,size__5479__auto__,b__23114,s__23112__$2,temp__5825__auto__){
return (function (){
...
var vec__23125 = cljs.core._nth(c__5478__auto____$1,i__23121);
...
var G__23337 = (i__23121 + (1));
i__23121 = G__23337;
continue;
} else {
var G__23338 = (i__23121 + (1));
i__23121 = G__23338;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23122),shitsuke$hig$tokens__GT_css_lines_$_iter__23111_$_iter__23119(cljs.core.chunk_rest(s__23120__$2)));
} else {
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__23111_$_iter__23119(cljs.core.rest(s__23120__$2)));
} else {
var G__23339 = cljs.core.rest(s__23120__$2);
s__23120__$1 = G__23339;
continue;
}
}
} else {
...
});})(i__23113,s__23112__$1,vec__23116,group,m,c__5478__auto__,size__5479__auto__,b__23114,s__23112__$2,temp__5825__auto__))
,null,null));
});})(i__23113,s__23112__$1,vec__23116,group,m,c__5478__auto__,size__5479__auto__,b__23114,s__23112__$2,temp__5825__auto__))
;
...
var G__23341 = (i__23113 + (1));
i__23113 = G__23341;
continue;
} else {
var G__23342 = (i__23113 + (1));
i__23113 = G__23342;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23114),shitsuke$hig$tokens__GT_css_lines_$_iter__23111(cljs.core.chunk_rest(s__23112__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23114),null);
}
} else {
var vec__23132 = cljs.core.first(s__23112__$2);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23132,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23132,(1),null);
if((!((m == null)))){
return cljs.core.cons(((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (s__23112__$1,vec__23132,group,m,s__23112__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__23111_$_iter__23135(s__23136){
return (new cljs.core.LazySeq(null,((function (s__23112__$1,vec__23132,group,m,s__23112__$2,temp__5825__auto__){
return (function (){
var s__23136__$1 = s__23136;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__23136__$1);
if(temp__5825__auto____$1){
var s__23136__$2 = temp__5825__auto____$1;
...
var vec__23140 = cljs.core._nth(c__5478__auto__,i__23137);
...
if((!((v == null)))){
cljs.core.chunk_append(b__23138,shitsuke.hig.pair__GT_css(group,k,v));

var G__23346 = (i__23137 + (1));
i__23137 = G__23346;
continue;
} else {
var G__23347 = (i__23137 + (1));
i__23137 = G__23347;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23138),shitsuke$hig$tokens__GT_css_lines_$_iter__23111_$_iter__23135(cljs.core.chunk_rest(s__23136__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23138),null);
}
} else {
var vec__23157 = cljs.core.first(s__23136__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__23111_$_iter__23135(cljs.core.rest(s__23136__$2)));
} else {
var G__23348 = cljs.core.rest(s__23136__$2);
s__23136__$1 = G__23348;
continue;
}
}
} else {
...
});})(s__23112__$1,vec__23132,group,m,s__23112__$2,temp__5825__auto__))
,null,null));
});})(s__23112__$1,vec__23132,group,m,s__23112__$2,temp__5825__auto__))
;
return iter__5480__auto__(m);
})()):["  --hig-",cljs.core.name(group),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(m),";"].join('')),shitsuke$hig$tokens__GT_css_lines_$_iter__23111(cljs.core.rest(s__23112__$2)));
} else {
var G__23349 = cljs.core.rest(s__23112__$2);
s__23112__$1 = G__23349;
continue;
}
}
} else {
 ...
 *   `@layer kotoba.hig`.
 */
shitsuke.hig.text_style_classes = ["@layer kotoba.hig {\n",clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$iter__23236(s__23237){
return (new cljs.core.LazySeq(null,(function (){
var s__23237__$1 = s__23237;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__23237__$1);
if(temp__5825__auto__){
var s__23237__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23237__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__23237__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__23239 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__23238 = (0);
while(true){
if((i__23238 < size__5479__auto__)){
var style = cljs.core._nth(c__5478__auto__,i__23238);
cljs.core.chunk_append(b__23239,[".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''));

var G__23354 = (i__23238 + (1));
i__23238 = G__23354;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23239),shitsuke$hig$iter__23236(cljs.core.chunk_rest(s__23237__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23239),null);
}
} else {
var style = cljs.core.first(s__23237__$2);
return cljs.core.cons([".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''),shitsuke$hig$iter__23236(cljs.core.rest(s__23237__$2)));
}
} else {
return null;
}
