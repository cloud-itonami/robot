 ...
 */
kotoba_ui.shell.with_root_attrs = (function kotoba_ui$shell$with_root_attrs(base,p__23545){
var map__23546 = p__23545;
var map__23546__$1 = cljs.core.__destructure_map(map__23546);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23546__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23546__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var attrs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23546__$1,new cljs.core.Keyword(null,"attrs","attrs",-2090668713));
var G__23547 = ((cljs.core.seq(attrs))?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs,base], 0)):base);
var G__23547__$1 = (((!((class$ == null))))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__23547,new cljs.core.Keyword(null,"class","class",-2030961996),kotoba_ui.shell.cls,kotoba_ui.shell.class_opt__GT_str(class$)):G__23547);
if((!((id == null)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23547__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__23547__$1;
}
});
...
var len__5726__auto___23681 = arguments.length;
var i__5727__auto___23682 = (0);
while(true){
if((i__5727__auto___23682 < len__5726__auto___23681)){
args__5732__auto__.push((arguments[i__5727__auto___23682]));

var G__23683 = (i__5727__auto___23682 + (1));
i__5727__auto___23682 = G__23683;
continue;
} else {
}
break;
...
var vec__23551 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23551,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23551,(1),null);
var map__23554 = opts;
var map__23554__$1 = cljs.core.__destructure_map(map__23554);
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23554__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var gap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23554__$1,new cljs.core.Keyword(null,"gap","gap",80255254));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23554__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var justify = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23554__$1,new cljs.core.Keyword(null,"justify","justify",-722524056));
...
/** @this {Function} */
(kotoba_ui.shell.stack.cljs$lang$applyTo = (function (seq23550){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23550));
}));
...
var args__5732__auto__ = [];
var len__5726__auto___23689 = arguments.length;
var i__5727__auto___23690 = (0);
while(true){
if((i__5727__auto___23690 < len__5726__auto___23689)){
args__5732__auto__.push((arguments[i__5727__auto___23690]));

var G__23691 = (i__5727__auto___23690 + (1));
i__5727__auto___23690 = G__23691;
continue;
} else {
}
break;
...
var vec__23559 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23559,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23559,(1),null);
var map__23562 = opts;
var map__23562__$1 = cljs.core.__destructure_map(map__23562);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23562__$1,new cljs.core.Keyword(null,"title","title",636505583));
var wide = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23562__$1,new cljs.core.Keyword(null,"wide","wide",-151772487));
...
/** @this {Function} */
(kotoba_ui.shell.section.cljs$lang$applyTo = (function (seq23558){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23558));
}));
...
var map__23563 = opts;
var map__23563__$1 = cljs.core.__destructure_map(map__23563);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23563__$1,new cljs.core.Keyword(null,"title","title",636505583));
var tagline = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23563__$1,new cljs.core.Keyword(null,"tagline","tagline",281987682));
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23563__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
...
var args__5732__auto__ = [];
var len__5726__auto___23692 = arguments.length;
var i__5727__auto___23693 = (0);
while(true){
if((i__5727__auto___23693 < len__5726__auto___23692)){
args__5732__auto__.push((arguments[i__5727__auto___23693]));

var G__23694 = (i__5727__auto___23693 + (1));
i__5727__auto___23693 = G__23694;
continue;
} else {
}
break;
...
var vec__23589 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23589,(0),null);
var cards = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23589,(1),null);
var map__23592 = opts;
var map__23592__$1 = cljs.core.__destructure_map(map__23592);
var min_w = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23592__$1,new cljs.core.Keyword(null,"min","min",444991522));
var gap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23592__$1,new cljs.core.Keyword(null,"gap","gap",80255254));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),kotoba_ui.shell.with_root_attrs((function (){var G__23612 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(kotoba_ui.shell.class_name.cljs$core$IFn$_invoke$arity$1 ? kotoba_ui.shell.class_name.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"grid","grid",402978600)) : kotoba_ui.shell.class_name.call(null, new cljs.core.Keyword(null,"grid","grid",402978600)))], null);
if(cljs.core.seq(style)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23612,new cljs.core.Keyword(null,"style","style",-496642736),style);
} else {
return G__23612;
}
})(),opts)], null),cards);
...
/** @this {Function} */
(kotoba_ui.shell.grid.cljs$lang$applyTo = (function (seq23564){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23564));
}));
...
var i__5727__auto___23696 = (0);
while(true){
if((i__5727__auto___23696 < len__5726__auto___23695)){
args__5732__auto__.push((arguments[i__5727__auto___23696]));

var G__23697 = (i__5727__auto___23696 + (1));
i__5727__auto___23696 = G__23697;
continue;
} else {
}
break;
...
var vec__23619 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23619,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23619,(1),null);
var map__23622 = opts;
var map__23622__$1 = cljs.core.__destructure_map(map__23622);
var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23622__$1,new cljs.core.Keyword(null,"nav","nav",719540477));
var sidebar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23622__$1,new cljs.core.Keyword(null,"sidebar","sidebar",35784458));
...
/** @this {Function} */
(kotoba_ui.shell.app_shell.cljs$lang$applyTo = (function (seq23618){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23618));
}));
...
var args__5732__auto__ = [];
var len__5726__auto___23700 = arguments.length;
var i__5727__auto___23701 = (0);
while(true){
if((i__5727__auto___23701 < len__5726__auto___23700)){
args__5732__auto__.push((arguments[i__5727__auto___23701]));

var G__23702 = (i__5727__auto___23701 + (1));
i__5727__auto___23701 = G__23702;
continue;
} else {
}
break;
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23636__$1,new cljs.core.Keyword(null,"title","title",636505583));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23636__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var lang = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23636__$1,new cljs.core.Keyword(null,"lang","lang",-1819677104));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23636__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var head = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23636__$1,new cljs.core.Keyword(null,"head","head",-771383919));
...
var map__23637 = kotoba_ui.theme.theme_colors(theme);
var map__23637__$1 = cljs.core.__destructure_map(map__23637);
var light = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23637__$1,new cljs.core.Keyword(null,"light","light",1918998747));
var dark = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23637__$1,new cljs.core.Keyword(null,"dark","dark",1818973999));
...
})()], null),(cljs.core.truth_(description)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"meta","meta",1499536964),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"description",new cljs.core.Keyword(null,"content","content",15833224),description], null)], null):null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(appearance,"dark"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__23660 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"theme-color",new cljs.core.Keyword(null,"content","content",15833224),light], null);
if((appearance == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23660,new cljs.core.Keyword(null,"media","media",-1066138403),"(prefers-color-scheme: light)");
} else {
return G__23660;
}
})()], null):null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(appearance,"light"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__23661 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"theme-color",new cljs.core.Keyword(null,"content","content",15833224),dark], null);
if((appearance == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23661,new cljs.core.Keyword(null,"media","media",-1066138403),"(prefers-color-scheme: dark)");
} else {
return G__23661;
}
...
/** @this {Function} */
(kotoba_ui.shell.page.cljs$lang$applyTo = (function (seq23628){
var G__23629 = cljs.core.first(seq23628);
var seq23628__$1 = cljs.core.next(seq23628);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23629,seq23628__$1);
}));
