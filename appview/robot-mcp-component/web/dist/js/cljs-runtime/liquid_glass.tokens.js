...
(liquid_glass.tokens.spring_linear_easing.cljs$core$IFn$_invoke$arity$1 = (function (p__22060){
var map__22061 = p__22060;
var map__22061__$1 = cljs.core.__destructure_map(map__22061);
var zeta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22061__$1,new cljs.core.Keyword(null,"zeta","zeta",257464678),0.55);
var omega = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22061__$1,new cljs.core.Keyword(null,"omega","omega",277265652),13.0);
var samples = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22061__$1,new cljs.core.Keyword(null,"samples","samples",635504833),(16));
...
return ["linear(",clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$iter__22074(s__22075){
return (new cljs.core.LazySeq(null,(function (){
var s__22075__$1 = s__22075;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22075__$1);
if(temp__5825__auto__){
var s__22075__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22075__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22075__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22077 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22076 = (0);
while(true){
if((i__22076 < size__5479__auto__)){
var i = cljs.core._nth(c__5478__auto__,i__22076);
cljs.core.chunk_append(b__22077,fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))));

var G__22214 = (i__22076 + (1));
i__22076 = G__22214;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22077),liquid_glass$tokens$iter__22074(cljs.core.chunk_rest(s__22075__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22077),null);
}
} else {
var i = cljs.core.first(s__22075__$2);
return cljs.core.cons(fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))),liquid_glass$tokens$iter__22074(cljs.core.rest(s__22075__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$pair__GT_css_$_iter__22149(s__22150){
return (new cljs.core.LazySeq(null,(function (){
var s__22150__$1 = s__22150;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22150__$1);
if(temp__5825__auto__){
var s__22150__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22150__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22150__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22152 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22151 = (0);
while(true){
if((i__22151 < size__5479__auto__)){
var vec__22167 = cljs.core._nth(c__5478__auto__,i__22151);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22167,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22167,(1),null);
cljs.core.chunk_append(b__22152,["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22216 = (i__22151 + (1));
i__22151 = G__22216;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22152),liquid_glass$tokens$pair__GT_css_$_iter__22149(cljs.core.chunk_rest(s__22150__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22152),null);
}
} else {
var vec__22177 = cljs.core.first(s__22150__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22177,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22177,(1),null);
return cljs.core.cons(["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),liquid_glass$tokens$pair__GT_css_$_iter__22149(cljs.core.rest(s__22150__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$tokens__GT_body_$_iter__22188(s__22189){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__22194 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22194,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22194,(1),null);
var iterys__5476__auto__ = ((function (s__22189__$1,vec__22194,group,m,xs__6385__auto__,temp__5825__auto__){
return (function liquid_glass$tokens$tokens__GT_body_$_iter__22188_$_iter__22190(s__22191){
return (new cljs.core.LazySeq(null,((function (s__22189__$1,vec__22194,group,m,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__22191__$1 = s__22191;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22191__$1);
if(temp__5825__auto____$1){
var s__22191__$2 = temp__5825__auto____$1;
...
var vec__22197 = cljs.core._nth(c__5478__auto__,i__22192);
...
if((!((v == null)))){
cljs.core.chunk_append(b__22193,liquid_glass.tokens.pair__GT_css(group,k,v));

var G__22219 = (i__22192 + (1));
i__22192 = G__22219;
continue;
} else {
var G__22220 = (i__22192 + (1));
i__22192 = G__22220;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22193),liquid_glass$tokens$tokens__GT_body_$_iter__22188_$_iter__22190(cljs.core.chunk_rest(s__22191__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22193),null);
}
} else {
var vec__22200 = cljs.core.first(s__22191__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22200,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22200,(1),null);
if((!((v == null)))){
return cljs.core.cons(liquid_glass.tokens.pair__GT_css(group,k,v),liquid_glass$tokens$tokens__GT_body_$_iter__22188_$_iter__22190(cljs.core.rest(s__22191__$2)));
} else {
var G__22221 = cljs.core.rest(s__22191__$2);
s__22191__$1 = G__22221;
continue;
}
}
} else {
...
});})(s__22189__$1,vec__22194,group,m,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__22189__$1,vec__22194,group,m,xs__6385__auto__,temp__5825__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,liquid_glass$tokens$tokens__GT_body_$_iter__22188(cljs.core.rest(s__22189__$1)));
} else {
var G__22222 = cljs.core.rest(s__22189__$1);
s__22189__$1 = G__22222;
continue;
}
} else {
return null;
